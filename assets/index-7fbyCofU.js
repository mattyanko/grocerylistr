...
*/var jt,Du;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(w,m){function y(){}y.prototype=m.prototype,w.D=m.prototype,w.prototype=new y,w.prototype.constructor=w,w.C=function(v,I,A){for(var g=Array(arguments.length-2),Ke=2;Ke<arguments.length;Ke++)g[Ke-2]=arguments[Ke];return m.prototype[I].apply(v,g)}}function t(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,t),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(w,m,y){y||(y=0);var v=Array(16);if(typeof m=="string")for(var I=0;16>I;++I)v[I]=m.charCodeAt(y++)|m.charCodeAt(y++)<<8|m.charCodeAt(y++)<<16|m.charCodeAt(y++)<<24;else for(I=0;16>I;++I)v[I]=m[y++]|m[y++]<<8|m[y++]<<16|m[y++]<<24;m=w.g[0],y=w.g[1],I=w.g[2];var A=w.g[3],g=m+(A^y&(I^A))+v[0]+3614090360&4294967295;m=y+(g<<7&4294967295|g>>>25),g=A+(I^m&(y^I))+v[1]+3905402710&4294967295,A=m+(g<<12&4294967295|g>>>20),g=I+(y^A&(m^y))+v[2]+606105819&4294967295,I=A+(g<<17&4294967295|g>>>15),g=y+(m^I&(A^m))+v[3]+3250441966&4294967295,y=I+(g<<22&4294967295|g>>>10),g=m+(A^y&(I^A))+v[4]+4118548399&4294967295,m=y+(g<<7&4294967295|g>>>25),g=A+(I^m&(y^I))+v[5]+1200080426&4294967295,A=m+(g<<12&4294967295|g>>>20),g=I+(y^A&(m^y))+v[6]+2821735955&4294967295,I=A+(g<<17&4294967295|g>>>15),g=y+(m^I&(A^m))+v[7]+4249261313&4294967295,y=I+(g<<22&4294967295|g>>>10),g=m+(A^y&(I^A))+v[8]+1770035416&4294967295,m=y+(g<<7&4294967295|g>>>25),g=A+(I^m&(y^I))+v[9]+2336552879&4294967295,A=m+(g<<12&4294967295|g>>>20),g=I+(y^A&(m^y))+v[10]+4294925233&4294967295,I=A+(g<<17&4294967295|g>>>15),g=y+(m^I&(A^m))+v[11]+2304563134&4294967295,y=I+(g<<22&4294967295|g>>>10),g=m+(A^y&(I^A))+v[12]+1804603682&4294967295,m=y+(g<<7&4294967295|g>>>25),g=A+(I^m&(y^I))+v[13]+4254626195&4294967295,A=m+(g<<12&4294967295|g>>>20),g=I+(y^A&(m^y))+v[14]+2792965006&4294967295,I=A+(g<<17&4294967295|g>>>15),g=y+(m^I&(A^m))+v[15]+1236535329&4294967295,y=I+(g<<22&4294967295|g>>>10),g=m+(I^A&(y^I))+v[1]+4129170786&4294967295,m=y+(g<<5&4294967295|g>>>27),g=A+(y^I&(m^y))+v[6]+3225465664&4294967295,A=m+(g<<9&4294967295|g>>>23),g=I+(m^y&(A^m))+v[11]+643717713&4294967295,I=A+(g<<14&4294967295|g>>>18),g=y+(A^m&(I^A))+v[0]+3921069994&4294967295,y=I+(g<<20&4294967295|g>>>12),g=m+(I^A&(y^I))+v[5]+3593408605&4294967295,m=y+(g<<5&4294967295|g>>>27),g=A+(y^I&(m^y))+v[10]+38016083&4294967295,A=m+(g<<9&4294967295|g>>>23),g=I+(m^y&(A^m))+v[15]+3634488961&4294967295,I=A+(g<<14&4294967295|g>>>18),g=y+(A^m&(I^A))+v[4]+3889429448&4294967295,y=I+(g<<20&4294967295|g>>>12),g=m+(I^A&(y^I))+v[9]+568446438&4294967295,m=y+(g<<5&4294967295|g>>>27),g=A+(y^I&(m^y))+v[14]+3275163606&4294967295,A=m+(g<<9&4294967295|g>>>23),g=I+(m^y&(A^m))+v[3]+4107603335&4294967295,I=A+(g<<14&4294967295|g>>>18),g=y+(A^m&(I^A))+v[8]+1163531501&4294967295,y=I+(g<<20&4294967295|g>>>12),g=m+(I^A&(y^I))+v[13]+2850285829&4294967295,m=y+(g<<5&4294967295|g>>>27),g=A+(y^I&(m^y))+v[2]+4243563512&4294967295,A=m+(g<<9&4294967295|g>>>23),g=I+(m^y&(A^m))+v[7]+1735328473&4294967295,I=A+(g<<14&4294967295|g>>>18),g=y+(A^m&(I^A))+v[12]+2368359562&4294967295,y=I+(g<<20&4294967295|g>>>12),g=m+(y^I^A)+v[5]+4294588738&4294967295,m=y+(g<<4&4294967295|g>>>28),g=A+(m^y^I)+v[8]+2272392833&4294967295,A=m+(g<<11&4294967295|g>>>21),g=I+(A^m^y)+v[11]+1839030562&4294967295,I=A+(g<<16&4294967295|g>>>16),g=y+(I^A^m)+v[14]+4259657740&4294967295,y=I+(g<<23&4294967295|g>>>9),g=m+(y^I^A)+v[1]+2763975236&4294967295,m=y+(g<<4&4294967295|g>>>28),g=A+(m^y^I)+v[4]+1272893353&4294967295,A=m+(g<<11&4294967295|g>>>21),g=I+(A^m^y)+v[7]+4139469664&4294967295,I=A+(g<<16&4294967295|g>>>16),g=y+(I^A^m)+v[10]+3200236656&4294967295,y=I+(g<<23&4294967295|g>>>9),g=m+(y^I^A)+v[13]+681279174&4294967295,m=y+(g<<4&4294967295|g>>>28),g=A+(m^y^I)+v[0]+3936430074&4294967295,A=m+(g<<11&4294967295|g>>>21),g=I+(A^m^y)+v[3]+3572445317&4294967295,I=A+(g<<16&4294967295|g>>>16),g=y+(I^A^m)+v[6]+76029189&4294967295,y=I+(g<<23&4294967295|g>>>9),g=m+(y^I^A)+v[9]+3654602809&4294967295,m=y+(g<<4&4294967295|g>>>28),g=A+(m^y^I)+v[12]+3873151461&4294967295,A=m+(g<<11&4294967295|g>>>21),g=I+(A^m^y)+v[15]+530742520&4294967295,I=A+(g<<16&4294967295|g>>>16),g=y+(I^A^m)+v[2]+3299628645&4294967295,y=I+(g<<23&4294967295|g>>>9),g=m+(I^(y|~A))+v[0]+4096336452&4294967295,m=y+(g<<6&4294967295|g>>>26),g=A+(y^(m|~I))+v[7]+1126891415&4294967295,A=m+(g<<10&4294967295|g>>>22),g=I+(m^(A|~y))+v[14]+2878612391&4294967295,I=A+(g<<15&4294967295|g>>>17),g=y+(A^(I|~m))+v[5]+4237533241&4294967295,y=I+(g<<21&4294967295|g>>>11),g=m+(I^(y|~A))+v[12]+1700485571&4294967295,m=y+(g<<6&4294967295|g>>>26),g=A+(y^(m|~I))+v[3]+2399980690&4294967295,A=m+(g<<10&4294967295|g>>>22),g=I+(m^(A|~y))+v[10]+4293915773&4294967295,I=A+(g<<15&4294967295|g>>>17),g=y+(A^(I|~m))+v[1]+2240044497&4294967295,y=I+(g<<21&4294967295|g>>>11),g=m+(I^(y|~A))+v[8]+1873313359&4294967295,m=y+(g<<6&4294967295|g>>>26),g=A+(y^(m|~I))+v[15]+4264355552&4294967295,A=m+(g<<10&4294967295|g>>>22),g=I+(m^(A|~y))+v[6]+2734768916&4294967295,I=A+(g<<15&4294967295|g>>>17),g=y+(A^(I|~m))+v[13]+1309151649&4294967295,y=I+(g<<21&4294967295|g>>>11),g=m+(I^(y|~A))+v[4]+4149444226&4294967295,m=y+(g<<6&4294967295|g>>>26),g=A+(y^(m|~I))+v[11]+3174756917&4294967295,A=m+(g<<10&4294967295|g>>>22),g=I+(m^(A|~y))+v[2]+718787259&4294967295,I=A+(g<<15&4294967295|g>>>17),g=y+(A^(I|~m))+v[9]+3951481745&4294967295,w.g[0]=w.g[0]+m&4294967295,w.g[1]=w.g[1]+(I+(g<<21&4294967295|g>>>11))&4294967295,w.g[2]=w.g[2]+I&4294967295,w.g[3]=w.g[3]+A&4294967295}r.prototype.u=function(w,m){m===void 0&&(m=w.length);for(var y=m-this.blockSize,v=this.B,I=this.h,A=0;A<m;){if(I==0)for(;A<=y;)s(this,w,A),A+=this.blockSize;if(typeof w=="string"){for(;A<m;)if(v[I++]=w.charCodeAt(A++),I==this.blockSize){s(this,v),I=0;break}}else for(;A<m;)if(v[I++]=w[A++],I==this.blockSize){s(this,v),I=0;break}}this.h=I,this.o+=m},r.prototype.v=function(){var w=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);w[0]=128;for(var m=1;m<w.length-8;++m)w[m]=0;var y=8*this.o;for(m=w.length-8;m<w.length;++m)w[m]=y&255,y/=256;for(this.u(w),w=Array(16),m=y=0;4>m;++m)for(var v=0;32>v;v+=8)w[y++]=this.g[m]>>>v&255;return w};function i(w,m){var y=l;return Object.prototype.hasOwnProperty.call(y,w)?y[w]:y[w]=m(w)}function a(w,m){this.h=m;for(var y=[],v=!0,I=w.length-1;0<=I;I--){var A=w[I]|0;v&&A==m||(y[I]=A,v=!1)}this.g=y}var l={};function u(w){return-128<=w&&128>w?i(w,function(m){return new a([m|0],0>m?-1:0)}):new a([w|0],0>w?-1:0)}function d(w){if(isNaN(w)||!isFinite(w))return _;if(0>w)return D(d(-w));for(var m=[],y=1,v=0;w>=y;v++)m[v]=w/y|0,y*=4294967296;return new a(m,0)}function p(w,m){if(w.length==0)throw Error("number format error: empty string");if(m=m||10,2>m||36<m)throw Error("radix out of range: "+m);if(w.charAt(0)=="-")return D(p(w.substring(1),m));if(0<=w.indexOf("-"))throw Error('number format error: interior "-" character');for(var y=d(Math.pow(m,8)),v=_,I=0;I<w.length;I+=8){var A=Math.min(8,w.length-I),g=parseInt(w.substring(I,I+A),m);8>A?(A=d(Math.pow(m,A)),v=v.j(A).add(d(g))):(v=v.j(y),v=v.add(d(g)))}return v}var _=u(0),E=u(1),S=u(16777216);n=a.prototype,n.m=function(){if(x(this))return-D(this).m();for(var w=0,m=1,y=0;y<this.g.length;y++){var v=this.i(y);w+=(0<=v?v:4294967296+v)*m,m*=4294967296}return w},n.toString=function(w){if(w=w||10,2>w||36<w)throw Error("radix out of range: "+w);if(P(this))return"0";if(x(this))return"-"+D(this).toString(w);for(var m=d(Math.pow(w,6)),y=this,v="";;){var I=re(y,m).g;y=W(y,I.j(m));var A=((0<y.g.length?y.g[0]:y.h)>>>0).toString(w);if(y=I,P(y))return A+v;for(;6>A.length;)A="0"+A;v=A+v}},n.i=function(w){return 0>w?0:w<this.g.length?this.g[w]:this.h};function P(w){if(w.h!=0)return!1;for(var m=0;m<w.g.length;m++)if(w.g[m]!=0)return!1;return!0}function x(w){return w.h==-1}n.l=function(w){return w=W(this,w),x(w)?-1:P(w)?0:1};function D(w){for(var m=w.g.length,y=[],v=0;v<m;v++)y[v]=~w.g[v];return new a(y,~w.h).add(E)}n.abs=function(){return x(this)?D(this):this},n.add=function(w){for(var m=Math.max(this.g.length,w.g.length),y=[],v=0,I=0;I<=m;I++){var A=v+(this.i(I)&65535)+(w.i(I)&65535),g=(A>>>16)+(this.i(I)>>>16)+(w.i(I)>>>16);v=g>>>16,A&=65535,g&=65535,y[I]=g<<16|A}return new a(y,y[y.length-1]&-2147483648?-1:0)};function W(w,m){return w.add(D(m))}n.j=function(w){if(P(this)||P(w))return _;if(x(this))return x(w)?D(this).j(D(w)):D(D(this).j(w));if(x(w))return D(this.j(D(w)));if(0>this.l(S)&&0>w.l(S))return d(this.m()*w.m());for(var m=this.g.length+w.g.length,y=[],v=0;v<2*m;v++)y[v]=0;for(v=0;v<this.g.length;v++)for(var I=0;I<w.g.length;I++){var A=this.i(v)>>>16,g=this.i(v)&65535,Ke=w.i(I)>>>16,kn=w.i(I)&65535;y[2*v+2*I]+=g*kn,K(y,2*v+2*I),y[2*v+2*I+1]+=A*kn,K(y,2*v+2*I+1),y[2*v+2*I+1]+=g*Ke,K(y,2*v+2*I+1),y[2*v+2*I+2]+=A*Ke,K(y,2*v+2*I+2)}for(v=0;v<m;v++)y[v]=y[2*v+1]<<16|y[2*v];for(v=m;v<2*m;v++)y[v]=0;return new a(y,0)};function K(w,m){for(;(w[m]&65535)!=w[m];)w[m+1]+=w[m]>>>16,w[m]&=65535,m++}function Q(w,m){this.g=w,this.h=m}function re(w,m){if(P(m))throw Error("division by zero");if(P(w))return new Q(_,_);if(x(w))return m=re(D(w),m),new Q(D(m.g),D(m.h));if(x(m))return m=re(w,D(m)),new Q(D(m.g),m.h);if(30<w.g.length){if(x(w)||x(m))throw Error("slowDivide_ only works with positive integers.");for(var y=E,v=m;0>=v.l(w);)y=xe(y),v=xe(v);var I=se(y,1),A=se(v,1);for(v=se(v,2),y=se(y,2);!P(v);){var g=A.add(v);0>=g.l(w)&&(I=I.add(y),A=g),v=se(v,1),y=se(y,1)}return m=W(w,I.j(m)),new Q(I,m)}for(I=_;0<=w.l(m);){for(y=Math.max(1,Math.floor(w.m()/m.m())),v=Math.ceil(Math.log(y)/Math.LN2),v=48>=v?1:Math.pow(2,v-48),A=d(y),g=A.j(m);x(g)||0<g.l(w);)y-=v,A=d(y),g=A.j(m);P(A)&&(A=E),I=I.add(A),w=W(w,g)}return new Q(I,w)}n.A=function(w){return re(this,w).h},n.and=function(w){for(var m=Math.max(this.g.length,w.g.length),y=[],v=0;v<m;v++)y[v]=this.i(v)&w.i(v);return new a(y,this.h&w.h)},n.or=function(w){for(var m=Math.max(this.g.length,w.g.length),y=[],v=0;v<m;v++)y[v]=this.i(v)|w.i(v);return new a(y,this.h|w.h)},n.xor=function(w){for(var m=Math.max(this.g.length,w.g.length),y=[],v=0;v<m;v++)y[v]=this.i(v)^w.i(v);return new a(y,this.h^w.h)};function xe(w){for(var m=w.g.length+1,y=[],v=0;v<m;v++)y[v]=w.i(v)<<1|w.i(v-1)>>>31;return new a(y,w.h)}function se(w,m){var y=m>>5;m%=32;for(var v=w.g.length-y,I=[],A=0;A<v;A++)I[A]=0<m?w.i(A+y)>>>m|w.i(A+y+1)<<32-m:w.i(A+y);return new a(I,w.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,Du=r,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.A,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=d,a.fromString=p,jt=a}).apply(typeof Wc<"u"?Wc:typeof self<"u"?self:typeof window<"u"?window:{});var Jr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ke{constructor(e){this.value=e}static empty(){return new ke({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let r=0;r<e.length-1;++r)if(t=(t.mapValue.fields||{})[e.get(r)],!os(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=nr(t)}setAll(e){let t=me.emptyPath(),r={},s=[];e.forEach((a,l)=>{if(!t.isImmediateParentOf(l)){const u=this.getFieldsMap(t);this.applyChanges(u,r,s),r={},s=[],t=l.popLast()}a?r[l.lastSegment()]=nr(a):s.push(l.lastSegment())});const i=this.getFieldsMap(t);this.applyChanges(i,r,s)}delete(e){const t=this.field(e.popLast());os(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return Ge(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let r=0;r<e.length;++r){let s=t.mapValue.fields[e.get(r)];os(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},t.mapValue.fields[e.get(r)]=s),t=s}return t.mapValue.fields}applyChanges(e,t,r){Xt(t,(s,i)=>e[s]=i);for(const s of r)delete e[s]}clone(){return new ke(nr(this.value))}}function qu(n){const e=[];return Xt(n.fields,(t,r)=>{const s=new me([t]);if(os(r)){const i=qu(r.mapValue).fields;if(i.length===0)e.push(s);else for(const a of i)e.push(s.child(a))}else e.push(s)}),new Le(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
They will return to their own lists.`))try{q("Removing access...");const e=Go(he,"users"),t=ra(e,sa("email","==",n)),r=await ca(t);if(!r.empty){const l=r.docs[0].id;await lt(Se(he,"users",l),{linkedTo:null})}const s=(J.linkedWith||[]).filter(a=>a!==n);await lt(Se(he,"users",oe.uid),{linkedWith:s}),q(`✓ Removed ${n} from shared lists`);const i=document.getElementById("manage-sharing-tab");i&&i.classList.contains("active")&&setTimeout(()=>fa(),500)}catch(e){console.error("Error unlinking user:",e),q("Failed to remove user","error")}};function ks(){ua.style.display="none",Zh.style.display="block",ha.style.display="none",qt.disabled=!1,qt.textContent="Sign In",$t.disabled=!1,$t.textContent="Create Account",document.getElementById("login-email").value="",document.getElementById("login-password").value="",document.getElementById("signup-email").value="",document.getElementById("signup-password").value=""}function io(){ua.style.display="none",Zh.style.display="none",ha.style.display="block"}function eE(){const n=document.querySelectorAll(".nav-item"),e={add:document.getElementById("add-tab"),lists:document.getElementById("lists-tab"),stores:document.getElementById("stores-tab"),history:document.getElementById("history-tab")},t={add:"Add Item",lists:"My Lists",stores:"Manage Stores",history:"Item History"};n.forEach(r=>{r.addEventListener("click",()=>{const s=r.dataset.tab;n.forEach(l=>l.classList.remove("active")),r.classList.add("active"),Object.values(e).forEach(l=>l.classList.remove("active"));const i=document.getElementById("manage-sharing-tab"),a=document.getElementById("settings-tab");i&&i.classList.remove("active"),a&&a.classList.remove("active"),e[s].classList.add("active"),da.textContent=t[s]})})}function tE(){const n=document.getElementById("item-name"),e=document.getElementById("add-item-btn");pa("item-name","item-name-autocomplete"),e.addEventListener("click",xl),n.addEventListener("keypress",t=>{t.key==="Enter"&&xl()})}function nE(){const n=document.getElementById("store-selector");!n||!V||(n.innerHTML="",V.stores.forEach(e=>{const t=document.createElement("div");t.className="store-chip",t.textContent=e,t.addEventListener("click",()=>{t.classList.toggle("selected")}),n.appendChild(t)}))}async function xl(){const n=document.getElementById("item-name").value.trim(),e=document.getElementById("add-quantity-display"),t=parseInt(e.textContent)||1;if(!n){q("Please enter an item name","error");return}const r=Array.from(document.querySelectorAll(".store-chip.selected")).map(s=>s.textContent);if(r.length===0){q("Please select at least one store","error");return}try{r.forEach(s=>{V.lists[s]||(V.lists[s]=[]);const i=V.lists[s].find(a=>a.name.toLowerCase()===n.toLowerCase());i?i.quantity=(i.quantity||1)+t:V.lists[s].push({name:n,checked:!1,quantity:t,isFavorite:!1})}),V.history.includes(n)||V.history.push(n),await De(),q(`✓ Added "${n}" ${t>1?`(${t})`:""} to ${r.length} store(s)`),document.getElementById("item-name").value="",e.textContent="1",document.querySelectorAll(".store-chip").forEach(s=>{s.classList.remove("selected")})}catch(s){console.error("Error adding item:",s),q("Failed to add item","error")}}window.adjustAddQuantity=function(n){const e=document.getElementById("add-quantity-display");let t=parseInt(e.textContent)||1;t+=n,t<1&&(t=1),t>99&&(t=99),e.textContent=t};function rE(n){const e=n.target.closest("[data-action]");if(!e)return;const t=e.dataset.action,r=e.dataset.store;t==="toggle-store"?toggleStore(r):t==="bought"?(n.stopPropagation(),removeBoughtItems(r)):t==="clear"&&(n.stopPropagation(),clearList(r))}let td=0,nd=0;function sE(n){const e=n.target.closest("[data-action]");if(!e)return;const t=n.changedTouches[0].clientY,r=Date.now(),s=Math.abs(t-td),i=r-nd;if(s>10||i>300){console.log("Scroll detected, ignoring touch");return}n.preventDefault();const a=e.dataset.action,l=e.dataset.store;console.log("Touch action:",a,"Store:",l),a==="toggle-store"?toggleStore(l):a==="bought"?(n.stopPropagation(),removeBoughtItems(l)):a==="clear"&&(n.stopPropagation(),clearList(l))}function Jt(){const n=document.getElementById("lists-tab");if(!n||!J)return;const e=localStorage.getItem("expandedStores");e&&(Ft=new Set(JSON.parse(e)));let t="";if(V.stores.length===0)t='<div class="card"><div class="empty-state"><div class="empty-icon">🏪</div><p>No stores yet. Add some in the Stores tab!</p></div></div>';else{let r=!1;V.stores.forEach(s=>{const i=V.lists[s]||[];if(i.length===0)return;r=!0;const a=i.filter(d=>!d.checked).length,l=s.replace(/\s+/g,"-"),u=Ft.has(s);t+=`
  ...
  `,d.querySelector(".qty-minus").addEventListener("click",E=>{E.stopPropagation(),p>1&&(p--,d.querySelector(".qty-display").textContent=p)}),d.querySelector(".qty-plus").addEventListener("click",E=>{E.stopPropagation(),p++,d.querySelector(".qty-display").textContent=p}),d.querySelector(".favorite-checkbox").addEventListener("change",E=>{E.stopPropagation(),_=E.target.checked}),d.querySelector(".qty-inline-ok").addEventListener("click",async E=>{E.stopPropagation(),n.quantity=p,n.isFavorite=_,Ol(n.name,"quantity",p),Ol(n.name,"isFavorite",_),await De(),d.classList.remove("expanded"),Jt()}),r.appendChild(s),r.appendChild(d),r}function Ol(n,e,t){V.stores.forEach(r=>{const i=(V.lists[r]||[]).find(a=>a.name.toLowerCase()===n.toLowerCase());i&&(i[e]=t)})}function gn(){const n=new Set;return V.stores.forEach(e=>{(V.lists[e]||[]).forEach(r=>{r.isFavorite&&n.add(r.name)})}),Array.from(n).sort()}window.setHistoryFilter=function(n){window.historyFilter=n,kr()};window.removeBoughtItems=async function(n){const t=(V.lists[n]||[]).filter(r=>r.checked);if(t.length===0){q("No bought items to remove","error");return}t.forEach(r=>{V.stores.forEach(s=>{V.lists[s]=(V.lists[s]||[]).filter(i=>i.name.toLowerCase()!==r.name.toLowerCase())})}),await De(),q(`✓ Removed ${t.length} bought item(s)`)};window.toggleStore=function(n){console.log("Toggle store:",n),Ft.has(n)?Ft.delete(n):Ft.add(n),localStorage.setItem("expandedStores",JSON.stringify([...Ft])),console.log("Expanded stores:",[...Ft]),Jt(),setTimeout(()=>{document.querySelectorAll(".quick-add-input").forEach(e=>{e.id.replace("quick-add-",""),pa(e.id,`${e.id}-autocomplete`)})},100)};window.clearList=async function(n){const e=document.getElementById("clear-modal"),t=document.getElementById("clear-store-name");t.textContent=n,e.dataset.store=n,e.classList.add("visible")};document.getElementById("clear-confirm-btn").addEventListener("click",async()=>{const n=document.getElementById("clear-modal"),e=n.dataset.store;e&&(V.lists[e]=[],await De(),q(`✓ Cleared ${e}`),n.classList.remove("visible"),n.dataset.store="")});document.getElementById("clear-cancel-btn").addEventListener("click",()=>{const n=document.getElementById("clear-modal");n.classList.remove("visible"),n.dataset.store=""});document.getElementById("clear-modal").addEventListener("click",n=>{if(n.target.id==="clear-modal"){const e=document.getElementById("clear-modal");e.classList.remove("visible"),e.dataset.store=""}});let Ct=null,un=null;function oE(n,e){Ct=n,un=e;const t=document.getElementById("delete-modal"),r=document.getElementById("delete-item-name"),s=document.getElementById("delete-store-name");r.textContent=`"${n}"`,s.textContent=`📍 Only from ${e}`,t.classList.add("visible")}function Js(){document.getElementById("delete-modal").classList.remove("visible"),Ct=null,un=null}document.getElementById("delete-all-btn").addEventListener("click",async()=>{Ct&&(V.stores.forEach(n=>{V.lists[n]=(V.lists[n]||[]).filter(e=>e.name.toLowerCase()!==Ct.toLowerCase())}),await De(),q(`✓ Removed "${Ct}" from all stores`),Js())});document.getElementById("delete-one-btn").addEventListener("click",async()=>{!Ct||!un||(V.lists[un]=(V.lists[un]||[]).filter(n=>n.name.toLowerCase()!==Ct.toLowerCase()),await De(),q(`✓ Removed "${Ct}" from ${un}`),Js())});document.getElementById("delete-cancel-btn").addEventListener("click",()=>{Js()});document.getElementById("delete-modal").addEventListener("click",n=>{n.target.id==="delete-modal"&&Js()});function aE(){const n=document.getElementById("stores-tab");if(!n||!J)return;let e=`
    <div class="card">
