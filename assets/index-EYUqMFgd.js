 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kp(n){En(new Qt("platform-logger",e=>new jf(e),"PRIVATE")),En(new Qt("heartbeat",e=>new Rp(e),"PRIVATE")),Pt(Wi,kc,n),Pt(Wi,kc,"esm2017"),Pt("fire-js","")}kp("");var Dp="firebase",Vp="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function yn(n,e){return Tr(n,"POST","/v1/accounts:signInWithIdp",pt(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Am="http://localhost";class Yt extends bo{constructor(){super(...arguments),this.pendingToken=null}static _fromParams(e){const t=new Yt(e.providerId,e.signInMethod);return e.idToken||e.accessToken?(e.idToken&&(t.idToken=e.idToken),e.accessToken&&(t.accessToken=e.accessToken),e.nonce&&!e.pendingToken&&(t.nonce=e.nonce),e.pendingToken&&(t.pendingToken=e.pendingToken)):e.oauthToken&&e.oauthTokenSecret?(t.accessToken=e.oauthToken,t.secret=e.oauthTokenSecret):Fe("argument-error"),t}toJSON(){return{idToken:this.idToken,accessToken:this.accessToken,secret:this.secret,nonce:this.nonce,pendingToken:this.pendingToken,providerId:this.providerId,signInMethod:this.signInMethod}}static fromJSON(e){const t=typeof e=="string"?JSON.parse(e):e,{providerId:r,signInMethod:s}=t,i=vo(t,["providerId","signInMethod"]);if(!r||!s)return null;const a=new Yt(r,s);return a.idToken=i.idToken||void 0,a.accessToken=i.accessToken||void 0,a.secret=i.secret,a.nonce=i.nonce,a.pendingToken=i.pendingToken||null,a}_getIdTokenResponse(e){const t=this.buildRequest();return yn(e,t)}_linkToIdToken(e,t){const r=this.buildRequest();return r.idToken=t,yn(e,r)}_getReauthenticationResolver(e){const t=this.buildRequest();return t.autoCreate=!1,yn(e,t)}buildRequest(){const e={requestUri:Am,returnSecureToken:!0};if(this.pendingToken)e.pendingToken=this.pendingToken;else{const t={};this.idToken&&(t.id_token=this.idToken),this.accessToken&&(t.access_token=this.accessToken),this.secret&&(t.oauth_token_secret=this.secret),t.providerId=this.providerId,this.nonce&&!this.pendingToken&&(t.nonce=this.nonce),e.postBody=wr(t)}return e}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class et extends Ar{constructor(){super("google.com"),this.addScope("profile")}static credential(e,t){return Yt._fromParams({providerId:et.PROVIDER_ID,signInMethod:et.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:t})}static credentialFromResult(e){return et.credentialFromTaggedObject(e)}static credentialFromError(e){return et.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:t,oauthAccessToken:r}=e;if(!t&&!r)return null;try{return et.credential(t,r)}catch{return null}}}et.GOOGLE_SIGN_IN_METHOD="google.com";et.PROVIDER_ID="google.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class At extends Ar{constructor(){super("github.com")}static credential(e){return Yt._fromParams({providerId:At.PROVIDER_ID,signInMethod:At.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return At.credentialFromTaggedObject(e)}static credentialFromError(e){return At.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return At.credential(e.oauthAccessToken)}catch{return null}}}At.GITHUB_SIGN_IN_METHOD="github.com";At.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bt extends Ar{constructor(){super("twitter.com")}static credential(e,t){return Yt._fromParams({providerId:bt.PROVIDER_ID,signInMethod:bt.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}static credentialFromResult(e){return bt.credentialFromTaggedObject(e)}static credentialFromError(e){return bt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:t,oauthTokenSecret:r}=e;if(!t||!r)return null;try{return bt.credential(t,r)}catch{return null}}}bt.TWITTER_SIGN_IN_METHOD="twitter.com";bt.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ru(n,e,t=!1){if(Be(n.app))return Promise.reject(st(n));const r="signIn",s=await Su(n,r,e),i=await Jt._fromIdTokenResponse(n,r,s);return t||await n._updateCurrentUser(i.user),i}async function km(n,e){return Ru(gt(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xt=new go("@firebase/firestore");function Jn(){return Xt.logLevel}function x(n,...e){if(Xt.logLevel<=W.DEBUG){const t=e.map(ko);Xt.debug(`Firestore (${Dn}): ${n}`,...t)}}function lt(n,...e){if(Xt.logLevel<=W.ERROR){const t=e.map(ko);Xt.error(`Firestore (${Dn}): ${n}`,...t)}}function wn(n,...e){if(Xt.logLevel<=W.WARN){const t=e.map(ko);Xt.warn(`Firestore (${Dn}): ${n}`,...t)}}function ko(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nl(n){let e=0;for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e++;return e}function nn(n,e){for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e(t,n[t])}function Qu(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vo(n){var e,t;return((t=(((e=n==null?void 0:n.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||t===void 0?void 0:t.stringValue)==="server_timestamp"}function Lo(n){const e=n.mapValue.fields.__previous_value__;return Vo(e)?Lo(e):e}function mr(n){const e=Nt(n.mapValue.fields.__local_write_time__.timestampValue);return new he(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class w_{constructor(){this.overlays=new ne(O.comparator),this.Ir=new Map}getOverlay(e,t){return P.resolve(this.overlays.get(t))}getOverlays(e,t){const r=Wt();return P.forEach(t,s=>this.getOverlay(e,s).next(i=>{i!==null&&r.set(s,i)})).next(()=>r)}saveOverlays(e,t,r){return r.forEach((s,i)=>{this.ht(e,t,i)}),P.resolve()}removeOverlaysForBatchId(e,t,r){const s=this.Ir.get(r);return s!==void 0&&(s.forEach(i=>this.overlays=this.overlays.remove(i)),this.Ir.delete(r)),P.resolve()}getOverlaysForCollection(e,t,r){const s=Wt(),i=t.length+1,a=new O(t.child("")),c=this.overlays.getIteratorFrom(a);for(;c.hasNext();){const u=c.getNext().value,d=u.getKey();if(!t.isPrefixOf(d.path))break;d.path.length===i&&u.largestBatchId>r&&s.set(u.getKey(),u)}return P.resolve(s)}getOverlaysForCollectionGroup(e,t,r,s){let i=new ne((d,p)=>d-p);const a=this.overlays.getIterator();for(;a.hasNext();){const d=a.getNext().value;if(d.getKey().getCollectionGroup()===t&&d.largestBatchId>r){let p=i.get(d.largestBatchId);p===null&&(p=Wt(),i=i.insert(d.largestBatchId,p)),p.set(d.getKey(),d)}}const c=Wt(),u=i.getIterator();for(;u.hasNext()&&(u.getNext().value.forEach((d,p)=>c.set(d,p)),!(c.size()>=s)););return P.resolve(c)}ht(e,t,r){const s=this.overlays.get(r.key);if(s!==null){const a=this.Ir.get(s.largestBatchId).delete(r.key);this.Ir.set(s.largestBatchId,a)}this.overlays=this.overlays.insert(r.key,new Wy(t,r));let i=this.Ir.get(t);i===void 0&&(i=j(),this.Ir.set(t,i)),this.Ir.set(t,i.add(r.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class k_{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return pf()?8:uy(Re())>0?6:4}()}initialize(e,t){this.Ji=e,this.indexManager=t,this.Gi=!0}getDocumentsMatchingQuery(e,t,r,s){const i={result:null};return this.Yi(e,t).next(a=>{i.result=a}).next(()=>{if(!i.result)return this.Zi(e,t,s,r).next(a=>{i.result=a})}).next(()=>{if(i.result)return;const a=new P_;return this.Xi(e,t,a).next(c=>{if(i.result=c,this.zi)return this.es(e,t,a,c.size)})}).next(()=>i.result)}es(e,t,r,s){return r.documentReadCount<this.ji?(Jn()<=W.DEBUG&&x("QueryEngine","SDK will not create cache indexes for query:",hn(t),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),P.resolve()):(Jn()<=W.DEBUG&&x("QueryEngine","Query:",hn(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.Hi*s?(Jn()<=W.DEBUG&&x("QueryEngine","The SDK decides to create cache indexes for query:",hn(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,We(t))):P.resolve())}Yi(e,t){if(dl(t))return P.resolve(null);let r=We(t);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(t.limit!==null&&s===1&&(t=no(t,null,"F"),r=We(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next(i=>{const a=j(...i);return this.Ji.getDocuments(e,a).next(c=>this.indexManager.getMinOffset(e,r).next(u=>{const d=this.ts(t,c);return this.ns(t,d,a,u.readTime)?this.Yi(e,no(t,null,"F")):this.rs(e,d,t,u)}))})))}Zi(e,t,r,s){return dl(t)||s.isEqual(U.min())?P.resolve(null):this.Ji.getDocuments(e,r).next(i=>{const a=this.ts(t,i);return this.ns(t,a,r,s)?P.resolve(null):(Jn()<=W.DEBUG&&x("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),hn(t)),this.rs(e,a,t,iy(s,-1)).next(c=>c))})}ts(e,t){let r=new ye(oh(e));return t.forEach((s,i)=>{zs(e,i)&&(r=r.add(i))}),r}ns(e,t,r,s){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const i=e.limitType==="F"?t.last():t.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}Xi(e,t,r){return Jn()<=W.DEBUG&&x("QueryEngine","Using full collection scan to execute query:",hn(t)),this.Ji.getDocumentsMatchingQuery(e,t,Lt.min(),r)}rs(e,t,r,s){return this.Ji.getDocumentsMatchingQuery(e,r,s).next(i=>(t.forEach(a=>{i=i.insert(a.key,a)}),i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ma(n){n=Me(n,Se);const e=Me(n.firestore,tn);return kv(ei(e),n._key).then(t=>ad(e,n,t))}class ga extends Hv{constructor(e){super(),this.firestore=e}convertBytes(e){return new Rn(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Se(this.firestore,null,t)}}function ya(n){n=Me(n,sn);const e=Me(n.firestore,tn),t=ei(e),r=new ga(e);return td(n._query),Dv(t,n._query).then(s=>new sd(e,r,n,s))}function id(n,e,t){n=Me(n,Se);const r=Me(n.firestore,tn),s=Gv(n.converter,e);return od(r,[Uv(aa(r),"setDoc",n._key,s,n.converter!==null,t).toMutation(n._key,ze.none())])}function Qe(n,e,t,...r){n=Me(n,Se);const s=Me(n.firestore,tn),i=aa(s);let a;return a=typeof(e=ue(e))=="string"||e instanceof ti?qv(i,"updateDoc",n._key,e,t,r):Bv(i,"updateDoc",n._key,e),od(s,[a.toMutation(n._key,ze.exists(!0))])}function Os(n,...e){var t,r,s;n=ue(n);let i={includeMetadataChanges:!1,source:"default"},a=0;typeof e[a]!="object"||Fl(e[a])||(i=e[a],a++);const c={includeMetadataChanges:i.includeMetadataChanges,source:i.source};if(Fl(e[a])){const _=e[a];e[a]=(t=_.next)===null||t===void 0?void 0:t.bind(_),e[a+1]=(r=_.error)===null||r===void 0?void 0:r.bind(_),e[a+2]=(s=_.complete)===null||s===void 0?void 0:s.bind(_)}let u,d,p;if(n instanceof Se)d=Me(n.firestore,tn),p=js(n._key.path),u={next:_=>{e[a]&&e[a](ad(d,n,_))},error:e[a+1],complete:e[a+2]};else{const _=Me(n,sn);d=Me(_.firestore,tn),p=_._query;const T=new ga(d);u={next:S=>{e[a]&&e[a](new sd(d,T,_,S))},error:e[a+1],complete:e[a+2]},td(n._query)}return function(T,S,C,N){const k=new ta(N),$=new Zo(S,k,C);return T.asyncQueue.enqueueAndForget(async()=>Yo(await Ns(T),$)),()=>{k.Za(),T.asyncQueue.enqueueAndForget(async()=>Jo(await Ns(T),$))}}(ei(d),p,c,u)}function od(n,e){return function(r,s){const i=new it;return r.asyncQueue.enqueueAndForget(async()=>vv(await Pv(r),s,i)),i.promise}(ei(n),e)}function ad(n,e,t){const r=t.docs.get(e._key),s=new ga(n);return new rd(n,s,e._key,r,new rr(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){(function(s){Dn=s})(Pn),En(new Qt("firestore",(r,{instanceIdentifier:s,options:i})=>{const a=r.getProvider("app").getImmediate(),c=new tn(new Xg(r.getProvider("auth-internal")),new ny(r.getProvider("app-check-internal")),function(d,p){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new L(R.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new gr(d.options.projectId,p)}(a,s),a);return i=Object.assign({useFetchStreams:t},i),c._setSettings(i),c},"PUBLIC").setMultipleInstances(!0)),Pt(tl,"4.7.3",e),Pt(tl,"4.7.3","esm2017")})();const Qv={apiKey:"AIzaSyA9N9iGCBld6BV0MxAWpF5tyMDPLwVxsxY",authDomain:"grocery-lists-29774.firebaseapp.com",projectId:"grocery-lists-29774",storageBucket:"grocery-lists-29774.firebasestorage.app",messagingSenderId:"260921375354",appId:"1:260921375354:web:0d3f81b657660bdd0719c3"},cd=nu(Qv),on=Kg(cd),ae=Nv(cd),_a=document.getElementById("loading-screen"),ld=document.getElementById("auth-container"),va=document.getElementById("app-container"),ql=document.getElementById("login-form"),$l=document.getElementById("signup-form"),zt=document.getElementById("login-btn"),Ht=document.getElementById("signup-btn"),Yv=document.getElementById("show-signup"),Jv=document.getElementById("show-login"),ur=document.getElementById("login-error"),sr=document.getElementById("signup-error"),Ea=document.getElementById("header-title"),Xv=document.getElementById("header-subtitle");let te=null,J=null,V=null,ps=null,ot=null,Ne=-1,Ze=!1,Ge=new Set,Gt=new Set,De={},Bi=null,pn="shared";const Zv=["Apples","Bananas","Oranges","Grapes","Strawberries","Blueberries","Raspberries","Blackberries","Watermelon","Cantaloupe","Honeydew","Pineapple","Mango","Papaya","Avocados","Tomatoes","Cucumbers","Lettuce","Spinach","Kale","Arugula","Cabbage","Broccoli","Cauliflower","Carrots","Celery","Bell Peppers","Jalapenos","Onions","Garlic","Ginger","Potatoes","Sweet Potatoes","Mushrooms","Zucchini","Squash","Asparagus","Green Beans","Peas","Corn","Eggplant","Radishes","Beets","Lemons","Limes","Fresh Herbs","Basil","Cilantro","Parsley","Mint","Rosemary","Thyme","Milk","Almond Milk","Oat Milk","Soy Milk","Cream","Half and Half","Butter","Margarine","Eggs","Cheese","Cheddar Cheese","Mozzarella","Parmesan","Feta","Cream Cheese","Cottage Cheese","Sour Cream","Yogurt","Greek Yogurt","Ice Cream","Chicken Breast","Chicken Thighs","Ground Chicken","Whole Chicken","Turkey","Ground Turkey","Beef","Ground Beef","Steak","Pork Chops","Bacon","Sausage","Ham","Hot Dogs","Deli Meat","Salmon","Tuna","Shrimp","Cod","Tilapia","Crab","Bread","Whole Wheat Bread","Sourdough","Bagels","English Muffins","Tortillas","Pita Bread","Croissants","Donuts","Muffins","Cookies","Cake","Pie","Rice","Brown Rice","Pasta","Spaghetti","Penne","Macaroni","Quinoa","Oats","Cereal","Granola","Flour","Sugar","Brown Sugar","Honey","Maple Syrup","Salt","Pepper","Olive Oil","Vegetable Oil","Coconut Oil","Vinegar","Soy Sauce","Hot Sauce","Ketchup","Mustard","Mayonnaise","BBQ Sauce","Salsa","Peanut Butter","Jam","Jelly","Canned Beans","Canned Tomatoes","Tomato Sauce","Pasta Sauce","Chicken Broth","Beef Broth","Vegetable Broth","Soup","Ramen","Mac and Cheese","Black Pepper","Garlic Powder","Onion Powder","Paprika","Cumin","Chili Powder","Oregano","Basil","Thyme","Cinnamon","Nutmeg","Vanilla Extract","Bay Leaves","Chips","Pretzels","Crackers","Popcorn","Nuts","Almonds","Cashews","Peanuts","Trail Mix","Granola Bars","Protein Bars","Candy","Chocolate","Gummy Bears","Coffee","Tea","Green Tea","Juice","Orange Juice","Apple Juice","Soda","Water","Sparkling Water","Energy Drinks","Sports Drinks","Wine","Beer","Kombucha","Frozen Pizza","Frozen Vegetables","Frozen Fruit","Ice Cream","Frozen Dinners","Frozen Chicken","Frozen Fish","French Fries","Tater Tots","Waffles","Pancakes","Canned Corn","Canned Peas","Canned Tuna","Canned Salmon","Pickles","Olives","Applesauce","Fruit Cups","Baking Powder","Baking Soda","Yeast","Chocolate Chips","Cocoa Powder","Powdered Sugar","Condensed Milk","Evaporated Milk","Paper Towels","Toilet Paper","Tissues","Trash Bags","Aluminum Foil","Plastic Wrap","Dish Soap","Laundry Detergent","Fabric Softener","Bleach","Sponges","Cleaning Spray","Napkins","Plates","Cups","Utensils","Batteries","Light Bulbs","Ziploc Bags","Toothpaste","Toothbrush","Mouthwash","Floss","Shampoo","Conditioner","Body Wash","Soap","Deodorant","Razors","Shaving Cream","Lotion","Sunscreen","Band-aids","Diapers","Baby Wipes","Baby Food","Formula","Dog Food","Cat Food","Cat Litter","Pet Treats"].sort();eE();function eE(){Om(on,async n=>{var e;if(n){te=n,console.log("User signed in:",n.email);const t=fe(ae,"users",n.uid),r=await ma(t),s=r.exists()?new Date(r.data().createdAt):null,i=new Date("2026-02-21");if(!n.emailVerified&&((e=n.providerData[0])==null?void 0:e.providerId)==="password"&&s&&s>=i){iE(n.email);return}oE()}else te=null,Ms()}),zt.addEventListener("click",jl),Ht.addEventListener("click",Wl),Yv.addEventListener("click",()=>{ql.style.display="none",$l.style.display="block",ur.classList.remove("show")}),Jv.addEventListener("click",()=>{$l.style.display="none",ql.style.display="block",sr.classList.remove("show")}),dE(),lE(),fE(),mE(),_E(),document.getElementById("login-email").addEventListener("keypress",n=>{n.key==="Enter"&&document.getElementById("login-password").focus()}),document.getElementById("login-password").addEventListener("keypress",n=>{n.key==="Enter"&&jl()}),document.getElementById("signup-email").addEventListener("keypress",n=>{n.key==="Enter"&&document.getElementById("signup-password").focus()}),document.getElementById("signup-password").addEventListener("keypress",n=>{n.key==="Enter"&&Wl()})}async function jl(){const n=document.getElementById("login-email").value.trim(),e=document.getElementById("login-password").value;if(!n||!e){vn(ur,"Please enter email and password");return}zt.disabled=!0,zt.textContent="Signing in...",ur.classList.remove("show");try{await Lm(on,n,e)}catch(t){console.error("Login error:",t);let r="Failed to sign in";t.code==="auth/invalid-credential"?r="Invalid email or password":t.code==="auth/too-many-requests"&&(r="Too many attempts. Try again later"),vn(ur,r),zt.disabled=!1,zt.textContent="Sign In"}}async function Wl(){const n=document.getElementById("signup-email").value.trim(),e=document.getElementById("signup-password").value;if(!n||!e){vn(sr,"Please enter email and password");return}if(e.length<6){vn(sr,"Password must be at least 6 characters");return}Ht.disabled=!0,Ht.textContent="Creating account...",sr.classList.remove("show");try{const t=await Vm(on,n,e);await Pu(t.user),await id(fe(ae,"users",t.user.uid),{email:n,createdAt:new Date().toISOString(),stores:["Costco","Save-On-Foods","T&T Market"],lists:{Costco:[],"Save-On-Foods":[],"T&T Market":[]},history:[],linkedTo:null,linkedWith:[],pendingInvites:[]}),rE(n)}catch(t){console.error("Signup error:",t);let r="Failed to create account";t.code==="auth/email-already-in-use"?r="Email already in use":t.code==="auth/invalid-email"&&(r="Invalid email address"),vn(sr,r),Ht.disabled=!1,Ht.textContent="Create Account"}}async function tE(){try{const n=document.getElementById("hamburger-menu");n&&n.classList.remove("visible"),ps&&(ps(),ps=null),ot&&(ot(),ot=null),await Mm(on)}catch(n){console.error("Logout error:",n)}}window.handleLogout=tE;async function nE(){const n=new et;try{console.log("Starting Google sign-in with popup...");const t=(await rg(on,n)).user;console.log("Google sign-in successful:",t.email);const r=fe(ae,"users",t.uid);(await ma(r)).exists()||(console.log("Creating new user document..."),await id(r,{email:t.email,createdAt:new Date().toISOString(),stores:["Costco","Save-On-Foods","T&T Market"],lists:{Costco:[],"Save-On-Foods":[],"T&T Market":[]},history:[],linkedTo:null,linkedWith:[],pendingInvites:[]}),console.log("User document created!")),console.log("Sign-in complete, waiting for auth state change...")}catch(e){if(console.error("Google sign-in error:",e),e.code==="auth/popup-closed-by-user"||e.code==="auth/cancelled-popup-request"){console.log("User closed the popup");return}let t="Failed to sign in with Google";e.code==="auth/popup-blocked"?t="Popup was blocked. Please allow popups for this site.":e.code==="auth/unauthorized-domain"&&(t="This domain is not authorized in Firebase."),vn(ur,t),console.error("Error details:",e.code,e.message)}}window.handleGoogleSignIn=nE;function rE(n){const e=document.getElementById("auth-container");e.innerHTML=`
  ...
  `}window.resendVerification=async function(){try{const n=on.currentUser;n?(await Pu(n),q("✓ Verification email sent!")):q("Please sign up again","error")}catch(n){console.error("Resend verification error:",n),q("Failed to send email","error")}};async function sE(){const n=document.getElementById("login-email"),e=(n==null?void 0:n.value.trim())||prompt("Enter your email address:");if(e)try{await Dm(on,e),q(`✓ Password reset email sent to ${e}`)}catch(t){console.error("Password reset error:",t),t.code==="auth/user-not-found"?q("No account found with that email","error"):t.code==="auth/invalid-email"?q("Invalid email address","error"):q("Failed to send reset email","error")}}window.handleForgotPassword=sE;function iE(n){const e=document.getElementById("auth-container");e.style.display="flex",va.style.display="none",_a.style.display="none",e.innerHTML=`
    <div class="auth-card" style="max-width: 400px; margin: 50px auto;">
...
They will return to their own lists.`))try{q("Removing access...");const e=na(ae,"users"),t=da(e,fa("email","==",n)),r=await ya(t);if(!r.empty){const c=r.docs[0].id;await Qe(fe(ae,"users",c),{linkedTo:null})}const s=(J.linkedWith||[]).filter(a=>a!==n);await Qe(fe(ae,"users",te.uid),{linkedWith:s}),q(`✓ Removed ${n} from shared lists`);const i=document.getElementById("manage-sharing-tab");i&&i.classList.contains("active")&&setTimeout(()=>wa(),500)}catch(e){console.error("Error unlinking user:",e),q("Failed to remove user","error")}};function Ms(){_a.style.display="none",ld.style.display="block",va.style.display="none",zt.disabled=!1,zt.textContent="Sign In",Ht.disabled=!1,Ht.textContent="Create Account",document.getElementById("login-email").value="",document.getElementById("login-password").value="",document.getElementById("signup-email").value="",document.getElementById("signup-password").value=""}function fo(){_a.style.display="none",ld.style.display="none",va.style.display="block"}function dE(){const n=document.querySelectorAll(".nav-item"),e={lists:document.getElementById("lists-tab"),stores:document.getElementById("stores-tab"),history:document.getElementById("history-tab")},t={lists:"My Lists",stores:"Manage Stores",history:"Item History"},r=document.getElementById("fab-add-btn");n.forEach(s=>{s.addEventListener("click",()=>{const i=s.dataset.tab;n.forEach(u=>u.classList.remove("active")),s.classList.add("active"),Object.values(e).forEach(u=>u.classList.remove("active"));const a=document.getElementById("manage-sharing-tab"),c=document.getElementById("settings-tab");a&&a.classList.remove("active"),c&&c.classList.remove("active"),e[i]&&e[i].classList.add("active"),Ea.textContent=t[i]||i,r&&(r.style.display=i==="lists"?"flex":"none")})})}function fE(){document.getElementById("fab-add-btn").addEventListener("click",pE)}function pE(){const n=pn==="private";document.getElementById("add-modal-title").textContent=n?"Add Private Item":"Add Item";const e=document.getElementById("modal-store-selector");e.innerHTML="",((V==null?void 0:V.stores)||[]).forEach(t=>{const r=document.createElement("div");r.className="store-chip",r.textContent=t,r.addEventListener("click",()=>r.classList.toggle("selected")),e.appendChild(r)}),document.getElementById("modal-item-name").value="",document.getElementById("modal-quantity-display").textContent="1",document.getElementById("add-modal").classList.add("visible"),setTimeout(()=>{Aa("modal-item-name","modal-item-name-autocomplete"),document.getElementById("modal-item-name").focus()},50)}function po(){document.getElementById("add-modal").classList.remove("visible")}function mE(){document.getElementById("modal-add-btn").addEventListener("click",zl),document.getElementById("modal-cancel-btn").addEventListener("click",po),document.getElementById("modal-qty-minus").addEventListener("click",()=>adjustModalQuantity(-1)),document.getElementById("modal-qty-plus").addEventListener("click",()=>adjustModalQuantity(1)),document.getElementById("modal-item-name").addEventListener("keypress",n=>{n.key==="Enter"&&zl()}),document.getElementById("add-modal").addEventListener("click",n=>{n.target.id==="add-modal"&&po()})}window.adjustModalQuantity=function(n){const e=document.getElementById("modal-quantity-display");let t=parseInt(e.textContent)||1;t=Math.max(1,Math.min(99,t+n)),e.textContent=t};async function zl(){const n=document.getElementById("modal-item-name").value.trim(),e=document.getElementById("modal-quantity-display"),t=parseInt(e.textContent)||1;if(!n){q("Please enter an item name","error");return}const r=Array.from(document.querySelectorAll("#modal-store-selector .store-chip.selected")).map(s=>s.textContent);if(r.length===0){q("Please select at least one store","error");return}try{const s=pn==="private",i=s?De:V.lists;r.forEach(a=>{i[a]||(i[a]=[]);const c=i[a].find(u=>u.name.toLowerCase()===n.toLowerCase());c?c.quantity=(c.quantity||1)+t:i[a].push({name:n,checked:!1,quantity:t,isFavorite:Dt().includes(n)})}),V.history.includes(n)||V.history.push(n),s?(await dt(),await ke()):await ke(),q(`✓ Added "${n}" ${t>1?`(${t})`:""} to ${r.length} store(s)`),po()}catch(s){console.error("Error adding item:",s),q("Failed to add item","error")}}let Ia=0,Ta=0;function hd(n){const e=n.target.closest("[data-action]");if(!e)return;const t=e.dataset.action,r=e.dataset.store,s=e.dataset.private==="true";t==="toggle-store"?toggleStore(r,s):t==="bought"?(n.stopPropagation(),removeBoughtItems(r,s)):t==="clear"?(n.stopPropagation(),clearList(r,!1)):t==="clear-private"&&(n.stopPropagation(),clearList(r,!0))}function dd(n){const e=n.target.closest("[data-action]");if(!e)return;const t=n.changedTouches[0].clientY,r=Date.now(),s=Math.abs(t-Ia),i=r-Ta;if(s>10||i>300)return;n.preventDefault();const a=e.dataset.action,c=e.dataset.store,u=e.dataset.private==="true";a==="toggle-store"?toggleStore(c,u):a==="bought"?(n.stopPropagation(),removeBoughtItems(c,u)):a==="clear"?(n.stopPropagation(),clearList(c,!1)):a==="clear-private"&&(n.stopPropagation(),clearList(c,!0))}function ht(){const n=document.getElementById("lists-tab");if(!n||!J)return;const e=localStorage.getItem("expandedStores");if(e&&(Gt=new Set(JSON.parse(e))),n.innerHTML=`
  ...
  `,n.querySelectorAll(".lists-subtab").forEach(t=>{t.addEventListener("click",()=>{pn=t.dataset.subtab,ht()})}),!document.getElementById("lists-styles")){const t=document.createElement("style");t.id="lists-styles",t.textContent=`
    ...
    `,document.head.appendChild(t)}pn==="shared"?gE():yE()}function fd(n,e,t,r,s){const i=e.filter(d=>!d.checked).length,a=e.filter(d=>d.checked).length,c=a>0?`<button class="store-action-btn btn-done" data-store="${n}" data-action="bought" data-private="${s}">✓ Remove Bought (${a})</button>`:"",u=s?"clear-private":"clear";return`
