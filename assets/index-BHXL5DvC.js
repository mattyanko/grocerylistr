 ...
 */const kl=function(n){const e=[];let t=0;for(let r=0;r<n.length;r++){let s=n.charCodeAt(r);s<128?e[t++]=s:s<2048?(e[t++]=s>>6|192,e[t++]=s&63|128):(s&64512)===55296&&r+1<n.length&&(n.charCodeAt(r+1)&64512)===56320?(s=65536+((s&1023)<<10)+(n.charCodeAt(++r)&1023),e[t++]=s>>18|240,e[t++]=s>>12&63|128,e[t++]=s>>6&63|128,e[t++]=s&63|128):(e[t++]=s>>12|224,e[t++]=s>>6&63|128,e[t++]=s&63|128)}return e},kd=function(n){const e=[];let t=0,r=0;for(;t<n.length;){const s=n[t++];if(s<128)e[r++]=String.fromCharCode(s);else if(s>191&&s<224){const o=n[t++];e[r++]=String.fromCharCode((s&31)<<6|o&63)}else if(s>239&&s<365){const o=n[t++],a=n[t++],l=n[t++],u=((s&7)<<18|(o&63)<<12|(a&63)<<6|l&63)-65536;e[r++]=String.fromCharCode(55296+(u>>10)),e[r++]=String.fromCharCode(56320+(u&1023))}else{const o=n[t++],a=n[t++];e[r++]=String.fromCharCode((s&15)<<12|(o&63)<<6|a&63)}}return e.join("")},Dl={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(n,e){if(!Array.isArray(n))throw Error("encodeByteArray takes an array as a parameter");this.init_();const t=e?this.byteToCharMapWebSafe_:this.byteToCharMap_,r=[];for(let s=0;s<n.length;s+=3){const o=n[s],a=s+1<n.length,l=a?n[s+1]:0,u=s+2<n.length,d=u?n[s+2]:0,p=o>>2,y=(o&3)<<4|l>>4;let A=(l&15)<<2|d>>6,R=d&63;u||(R=64,a||(A=64)),r.push(t[p],t[y],t[A],t[R])}return r.join("")},encodeString(n,e){return this.HAS_NATIVE_SUPPORT&&!e?btoa(n):this.encodeByteArray(kl(n),e)},decodeString(n,e){return this.HAS_NATIVE_SUPPORT&&!e?atob(n):kd(this.decodeStringToByteArray(n,e))},decodeStringToByteArray(n,e){this.init_();const t=e?this.charToByteMapWebSafe_:this.charToByteMap_,r=[];for(let s=0;s<n.length;){const o=t[n.charAt(s++)],l=s<n.length?t[n.charAt(s)]:0;++s;const d=s<n.length?t[n.charAt(s)]:64;++s;const y=s<n.length?t[n.charAt(s)]:64;if(++s,o==null||l==null||d==null||y==null)throw new Dd;const A=o<<2|l>>4;if(r.push(A),d!==64){const R=l<<4&240|d>>2;if(r.push(R),y!==64){const k=d<<6&192|y;r.push(k)}}}return r},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let n=0;n<this.ENCODED_VALS.length;n++)this.byteToCharMap_[n]=this.ENCODED_VALS.charAt(n),this.charToByteMap_[this.byteToCharMap_[n]]=n,this.byteToCharMapWebSafe_[n]=this.ENCODED_VALS_WEBSAFE.charAt(n),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[n]]=n,n>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(n)]=n,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(n)]=n)}}};class Dd extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const Vd=function(n){const e=kl(n);return Dl.encodeByteArray(e,!0)},as=function(n){return Vd(n).replace(/\./g,"")},Vl=function(n){try{return Dl.decodeString(n,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wf{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(Tf(t)){const r=t.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(t=>t).join(" ")}}function Tf(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Ni="@firebase/app",fc="0.10.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const In=Yf;function Fl(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const r=Object.assign({name:Li,automaticDataCollectionEnabled:!1},e),s=r.name;if(typeof s!="string"||!s)throw wt.create("bad-app-name",{appName:String(s)});if(t||(t=Ll()),!t)throw wt.create("no-options");const o=ls.get(s);if(o){if(cs(t,o.options)&&cs(r,o.config))return o;throw wt.create("duplicate-app",{appName:s})}const a=new of(s);for(const u of Oi.values())a.addComponent(u);const l=new ep(t,r,a);return ls.set(s,l),l}function Ul(n=Li){const e=ls.get(n);if(!e&&n===Li&&Ll())return Fl();if(!e)throw wt.create("no-app",{appName:n});return e}function Tt(n,e,t){var r;let s=(r=Jf[n])!==null&&r!==void 0?r:n;t&&(s+=`-${t}`);const o=s.match(/\s|\//),a=e.match(/\s|\//);if(o||a){const l=[`Unable to register library "${s}" with version "${e}":`];o&&l.push(`library name "${s}" contains illegal characters (whitespace or "/")`),o&&a&&l.push("and"),a&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),st.warn(l.join(" "));return}fn(new qt(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lp(n){fn(new qt("platform-logger",e=>new wf(e),"PRIVATE")),fn(new qt("heartbeat",e=>new op(e),"PRIVATE")),Tt(Ni,fc,n),Tt(Ni,fc,"esm2017"),Tt("fire-js","")}lp("");var up="firebase",hp="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Tt(up,hp,"app");function ao(n,e){var t={};for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&e.indexOf(r)<0&&(t[r]=n[r]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var s=0,r=Object.getOwnPropertySymbols(n);s<r.length;s++)e.indexOf(r[s])<0&&Object.prototype.propertyIsEnumerable.call(n,r[s])&&(t[r[s]]=n[r[s]]);return t}function ql(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const dp=ql,jl=new dr("auth","Firebase",ql());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xi(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.href)||""}function pp(){return yc()==="http:"||yc()==="https:"}function yc(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Tp(n,e){return kt(n,"POST","/v1/accounts:delete",e)}async function Kl(n,e){return kt(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hs(n){var e;const t=n.auth,r=await n.getIdToken(),s=await sr(n,Kl(t,{idToken:r}));M(s==null?void 0:s.users.length,t,"internal-error");const o=s.users[0];n._notifyReloadListener(o);const a=!((e=o.providerUserInfo)===null||e===void 0)&&e.length?Ql(o.providerUserInfo):[],l=Pp(n.providerData,a),u=n.isAnonymous,d=!(n.email&&o.passwordHash)&&!(l!=null&&l.length),p=u?d:!1,y={uid:o.localId,displayName:o.displayName||null,photoURL:o.photoUrl||null,email:o.email||null,emailVerified:o.emailVerified||!1,phoneNumber:o.phoneNumber||null,tenantId:o.tenantId||null,providerData:l,metadata:new Mi(o.createdAt,o.lastLoginAt),isAnonymous:p};Object.assign(n,y)}async function Sp(n){const e=ue(n);await hs(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function Pp(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function Ql(n){return n.map(e=>{var{providerId:t}=e,r=ao(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Cp(n,e){const t=await Hl(n,{},async()=>{const r=fr({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:o}=n.config,a=Gl(n,s,"/v1/token",`key=${o}`),l=await n._getAdditionalHeaders();return l["Content-Type"]="application/x-www-form-urlencoded",zl.fetch()(a,{method:"POST",headers:l,body:r})});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function kp(n,e){return kt(n,"POST","/v2/accounts:revokeToken",Ct(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ic=new Map;function et(n){it(n instanceof Function,"Expected a class definition");let e=Ic.get(n);return e?(it(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,Ic.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yl{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,t){this.storage[e]=t}async _get(e){const t=this.storage[e];return t===void 0?null:t}async _remove(e){delete this.storage[e]}_addListener(e,t){}_removeListener(e,t){}}Yl.type="NONE";const wc=Yl;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tc(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(eu(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Jl(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(nu(e))return"Blackberry";if(ru(e))return"Webos";if(Xl(e))return"Safari";if((e.includes("chrome/")||Zl(e))&&!e.includes("edge/"))return"Chrome";if(tu(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function Jl(n=Re()){return/firefox\//i.test(n)}function Xl(n=Re()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Zl(n=Re()){return/crios\//i.test(n)}function eu(n=Re()){return/iemobile/i.test(n)}function tu(n=Re()){return/android/i.test(n)}function nu(n=Re()){return/blackberry/i.test(n)}function ru(n=Re()){return/webos/i.test(n)}function ho(n=Re()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function Dp(n=Re()){var e;return ho(n)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function Vp(){return zd()&&document.documentMode===10}function su(n=Re()){return ho(n)||tu(n)||ru(n)||nu(n)||/windows phone/i.test(n)||eu(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function iu(n,e=[]){let t;switch(n){case"Browser":t=Tc(Re());break;case"Worker":t=`${Tc(Re())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${In}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zp(n,e){const t=oo(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),o=t.getOptions();if(cs(o,e??{}))return s;Fe(s,"already-initialized")}return t.initialize({options:e})}function Hp(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(et);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function Gp(n,e,t){const r=Qt(n);M(r._canInitEmulator,r,"emulator-config-failed"),M(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,o=au(e),{host:a,port:l}=Kp(e),u=l===null?"":`:${l}`;r.config.emulator={url:`${o}//${a}${u}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:a,port:l,protocol:o.replace(":",""),options:Object.freeze({disableWarnings:s})}),Qp()}function au(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function Kp(n){const e=au(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const o=s[1];return{host:o,port:Rc(r.substr(o.length+1))}}else{const[o,a]=r.split(":");return{host:o,port:Rc(a)}}}function Rc(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function Qp(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function uu(n,e,t=!1){if(Be(n.app))return Promise.reject(tt(n));const r="signIn",s=await lu(n,r,e),o=await Wt._fromIdTokenResponse(n,r,s);return t||await n._updateCurrentUser(o.user),o}async function om(n,e){return uu(Qt(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hu(n){const e=Qt(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function am(n,e,t){if(Be(n.app))return Promise.reject(tt(n));const r=Qt(n),a=await Fi(r,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",rm).catch(u=>{throw u.code==="auth/password-does-not-meet-requirements"&&hu(n),u}),l=await Wt._fromIdTokenResponse(r,"signIn",a);return await r._updateCurrentUser(l.user),l}function cm(n,e,t){return Be(n.app)?Promise.reject(tt(n)):om(ue(n),wn.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&hu(n),r})}function lm(n,e,t,r){return ue(n).onIdTokenChanged(e,t,r)}function um(n,e,t){return ue(n).beforeAuthStateChanged(e,t)}function hm(n,e,t,r){return ue(n).onAuthStateChanged(e,t,r)}function dm(n){return ue(n).signOut()}const fs="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gu(){return typeof qe().WorkerGlobalScope<"u"&&typeof qe().importScripts=="function"}async function vm(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Em(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)===null||n===void 0?void 0:n.controller)||null}function Im(){return gu()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Eu{constructor(e,t,r,s,o=!1){this.auth=e,this.resolver=r,this.user=s,this.bypassAuthState=o,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:r,postBody:s,tenantId:o,error:a,type:l}=e;if(a){this.reject(a);return}const u={auth:this.auth,requestUri:t,sessionId:r,tenantId:o||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(l)(u))}catch(d){this.reject(d)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Cm;case"linkViaPopup":case"linkViaRedirect":return Dm;case"reauthViaPopup":case"reauthViaRedirect":return km;default:Fe(this.auth,"internal-error")}}resolve(e){it(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){it(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nm="pendingRedirect",Xr=new Map;class Lm extends Eu{constructor(e,t,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,r),this.eventId=null}async execute(){let e=Xr.get(this.auth._key());if(!e){try{const r=await Om(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(t){e=()=>Promise.reject(t)}Xr.set(this.auth._key(),e)}return this.bypassAuthState||Xr.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function Om(n,e){const t=Fm(e),r=Mm(n);if(!await r._isAvailable())return!1;const s=await r._get(t)==="true";return await r._remove(t),s}function xm(n,e){Xr.set(n._key(),e)}function Mm(n){return et(n._redirectPersistence)}function Fm(n){return Jr(Nm,n.config.apiKey,n.name)}async function Um(n,e,t=!1){if(Be(n.app))return Promise.reject(tt(n));const r=Qt(n),s=Pm(r,e),a=await new Lm(r,s,t).execute();return a&&!t&&(delete a.user._redirectEventId,await r._persistUserIfCurrent(a.user),await r._setRedirectUser(null,e)),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Km=new pr(3e4,6e4);function Dc(){const n=qe().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function Qm(n){return new Promise((e,t)=>{var r,s,o;function a(){Dc(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Dc(),t($e(n,"network-request-failed"))},timeout:Km.get()})}if(!((s=(r=qe().gapi)===null||r===void 0?void 0:r.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((o=qe().gapi)===null||o===void 0)&&o.load)a();else{const l=$p("iframefcb");return qe()[l]=()=>{gapi.load?a():t($e(n,"network-request-failed"))},ou(`${Bp()}?onload=${l}`).catch(u=>t(u))}}).catch(e=>{throw Zr=null,e})}let Zr=null;function Ym(n){return Zr=Zr||Qm(n),Zr}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sg={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},ig=500,og=600,ag="_blank",cg="http://localhost";class Vc{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function lg(n,e,t,r=ig,s=og){const o=Math.max((window.screen.availHeight-s)/2,0).toString(),a=Math.max((window.screen.availWidth-r)/2,0).toString();let l="";const u=Object.assign(Object.assign({},sg),{width:r.toString(),height:s.toString(),top:o,left:a}),d=Re().toLowerCase();t&&(l=Zl(d)?ag:t),Jl(d)&&(e=e||cg,u.scrollbars="yes");const p=Object.entries(u).reduce((A,[R,k])=>`${A}${R}=${k},`,"");if(Dp(d)&&l!=="_self")return ug(e||"",l),new Vc(null);const y=window.open(e||"",l,p);M(y,n,"popup-blocked");try{y.focus()}catch{}return new Vc(y)}function ug(n,e){const t=document.createElement("a");t.href=n,t.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class e_{constructor(e,t=null,r=[],s=[],o=null,a=null,l=null){this.path=e,this.collectionGroup=t,this.orderBy=r,this.filters=s,this.limit=o,this.startAt=a,this.endAt=l,this.ue=null}}function Kc(n,e=null,t=[],r=[],s=null,o=null,a=null){return new e_(n,e,t,r,s,o,a)}function wo(n){const e=B(n);if(e.ue===null){let t=e.path.canonicalString();e.collectionGroup!==null&&(t+="|cg:"+e.collectionGroup),t+="|f:",t+=e.filters.map(r=>ji(r)).join(","),t+="|ob:",t+=e.orderBy.map(r=>function(o){return o.field.canonicalString()+o.dir}(r)).join(","),ks(e.limit)||(t+="|l:",t+=e.limit),e.startAt&&(t+="|lb:",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map(r=>_n(r)).join(",")),e.endAt&&(t+="|ub:",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map(r=>_n(r)).join(",")),e.ue=t}return e.ue}function To(n,e){if(n.limit!==e.limit||n.orderBy.length!==e.orderBy.length)return!1;for(let t=0;t<n.orderBy.length;t++)if(!zg(n.orderBy[t],e.orderBy[t]))return!1;if(n.filters.length!==e.filters.length)return!1;for(let t=0;t<n.filters.length;t++)if(!xu(n.filters[t],e.filters[t]))return!1;return n.collectionGroup===e.collectionGroup&&!!n.path.isEqual(e.path)&&!!Gc(n.startAt,e.startAt)&&Gc(n.endAt,e.endAt)}function Wi(n){return x.isDocumentKey(n.path)&&n.collectionGroup===null&&n.filters.length===0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const i_=new te(x.comparator);function at(){return i_}const qu=new te(x.comparator);function Gn(...n){let e=qu;for(const t of n)e=e.insert(t.key,t);return e}function ju(n){let e=qu;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function Ft(){return er()}function Wu(){return er()}function er(){return new An(n=>n.toString(),(n,e)=>n.isEqual(e))}const o_=new te(x.comparator),a_=new me(x.comparator);function $(...n){let e=a_;for(const t of n)e=e.add(t);return e}const c_=new me(H);function l_(){return c_}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ao(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:ms(e)?"-0":e}}function zu(n){return{integerValue:""+n}}function u_(n,e){return Bg(e)?zu(e):Ao(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Y_{constructor(){this.overlays=new te(x.comparator),this.Ir=new Map}getOverlay(e,t){return P.resolve(this.overlays.get(t))}getOverlays(e,t){const r=Ft();return P.forEach(t,s=>this.getOverlay(e,s).next(o=>{o!==null&&r.set(s,o)})).next(()=>r)}saveOverlays(e,t,r){return r.forEach((s,o)=>{this.ht(e,t,o)}),P.resolve()}removeOverlaysForBatchId(e,t,r){const s=this.Ir.get(r);return s!==void 0&&(s.forEach(o=>this.overlays=this.overlays.remove(o)),this.Ir.delete(r)),P.resolve()}getOverlaysForCollection(e,t,r){const s=Ft(),o=t.length+1,a=new x(t.child("")),l=this.overlays.getIteratorFrom(a);for(;l.hasNext();){const u=l.getNext().value,d=u.getKey();if(!t.isPrefixOf(d.path))break;d.path.length===o&&u.largestBatchId>r&&s.set(u.getKey(),u)}return P.resolve(s)}getOverlaysForCollectionGroup(e,t,r,s){let o=new te((d,p)=>d-p);const a=this.overlays.getIterator();for(;a.hasNext();){const d=a.getNext().value;if(d.getKey().getCollectionGroup()===t&&d.largestBatchId>r){let p=o.get(d.largestBatchId);p===null&&(p=Ft(),o=o.insert(d.largestBatchId,p)),p.set(d.getKey(),d)}}const l=Ft(),u=o.getIterator();for(;u.hasNext()&&(u.getNext().value.forEach((d,p)=>l.set(d,p)),!(l.size()>=s)););return P.resolve(l)}ht(e,t,r){const s=this.overlays.get(r.key);if(s!==null){const a=this.Ir.get(s.largestBatchId).delete(r.key);this.Ir.set(s.largestBatchId,a)}this.overlays=this.overlays.insert(r.key,new v_(t,r));let o=this.Ir.get(t);o===void 0&&(o=$(),this.Ir.set(t,o)),this.Ir.set(t,o.add(r.key))}}/**
 * @license
...
They will return to their own lists.`))try{K("Removing access...");const e=jo(ge,"users"),t=Zo(e,ea("email","==",n)),r=await ra(t);if(!r.empty){const l=r.docs[0].id;await ct(ke(ge,"users",l),{linkedTo:null})}const s=(J.linkedWith||[]).filter(a=>a!==n);await ct(ke(ge,"users",oe.uid),{linkedWith:s}),K(`✓ Removed ${n} from shared lists`);const o=document.getElementById("manage-sharing-tab");o&&o.classList.contains("active")&&setTimeout(()=>oa(),500)}catch(e){console.error("Error unlinking user:",e),K("Failed to remove user","error")}};function bs(){jh.style.display="none",Wh.style.display="block",zh.style.display="none",Ut.disabled=!1,Ut.textContent="Sign In",Bt.disabled=!1,Bt.textContent="Create Account",document.getElementById("login-email").value="",document.getElementById("login-password").value="",document.getElementById("signup-email").value="",document.getElementById("signup-password").value=""}function ro(){jh.style.display="none",Wh.style.display="none",zh.style.display="block"}function Uv(){const n=document.querySelectorAll(".nav-item"),e={add:document.getElementById("add-tab"),lists:document.getElementById("lists-tab"),stores:document.getElementById("stores-tab"),history:document.getElementById("history-tab")},t={add:"Add Item",lists:"My Lists",stores:"Manage Stores",history:"Item History"};n.forEach(r=>{r.addEventListener("click",()=>{const s=r.dataset.tab;n.forEach(l=>l.classList.remove("active")),r.classList.add("active"),Object.values(e).forEach(l=>l.classList.remove("active"));const o=document.getElementById("manage-sharing-tab"),a=document.getElementById("settings-tab");o&&o.classList.remove("active"),a&&a.classList.remove("active"),e[s].classList.add("active"),ia.textContent=t[s]})})}function Bv(){const n=document.getElementById("item-name"),e=document.getElementById("add-item-btn");aa("item-name","item-name-autocomplete"),e.addEventListener("click",Pl),n.addEventListener("keypress",t=>{t.key==="Enter"&&Pl()})}function $v(){const n=document.getElementById("store-selector");!n||!V||(n.innerHTML="",V.stores.forEach(e=>{const t=document.createElement("div");t.className="store-chip",t.textContent=e,t.addEventListener("click",()=>{t.classList.toggle("selected")}),n.appendChild(t)}))}async function Pl(){const n=document.getElementById("item-name").value.trim();if(!n){K("Please enter an item name","error");return}const e=Array.from(document.querySelectorAll(".store-chip.selected")).map(t=>t.textContent);if(e.length===0){K("Please select at least one store","error");return}try{e.forEach(t=>{V.lists[t]||(V.lists[t]=[]),V.lists[t].some(s=>s.name.toLowerCase()===n.toLowerCase())||V.lists[t].push({name:n,checked:!1})}),V.history.includes(n)||V.history.push(n),await xe(),K(`✓ Added "${n}" to ${e.length} store(s)`),document.getElementById("item-name").value="",document.querySelectorAll(".store-chip").forEach(t=>{t.classList.remove("selected")})}catch(t){console.error("Error adding item:",t),K("Failed to add item","error")}}function qv(n){const e=n.target.closest("[data-action]");if(!e)return;const t=e.dataset.action,r=e.dataset.store;t==="toggle-store"?toggleStore(r):t==="bought"?(n.stopPropagation(),removeBoughtItems(r)):t==="clear"&&(n.stopPropagation(),clearList(r))}function jv(n){const e=n.target.closest("[data-action]");if(!e)return;n.preventDefault();const t=e.dataset.action,r=e.dataset.store;console.log("Touch action:",t,"Store:",r),t==="toggle-store"?toggleStore(r):t==="bought"?(n.stopPropagation(),removeBoughtItems(r)):t==="clear"&&(n.stopPropagation(),clearList(r))}function Gh(){const n=document.getElementById("lists-tab");if(!n||!J)return;const e=localStorage.getItem("expandedStores");e&&(Mt=new Set(JSON.parse(e)));let t="";if(V.stores.length===0)t='<div class="card"><div class="empty-state"><div class="empty-icon">🏪</div><p>No stores yet. Add some in the Stores tab!</p></div></div>';else{let r=!1;V.stores.forEach(s=>{const o=V.lists[s]||[];if(o.length===0)return;r=!0;const a=o.filter(d=>!d.checked).length,l=s.replace(/\s+/g,"-"),u=Mt.has(s);t+=`
      ...
      `}),r||(t='<div class="card"><div class="empty-state"><div class="empty-icon">📝</div><p>No items yet. Add some in the Add tab!</p></div></div>')}if(n.innerHTML=t,n.addEventListener("click",qv),n.addEventListener("touchend",jv),!document.getElementById("lists-styles")){const r=document.createElement("style");r.id="lists-styles",r.textContent=`
      .quick-add-inline {
        display: flex;
        gap: 10px;
        margin-bottom: 16px;
  ...
  `;n.innerHTML=e}window.sendShareInvite=async function(){const n=document.getElementById("share-email"),e=n.value.trim().toLowerCase(),t=document.getElementById("share-status");if(!e){mt(t,"Please enter an email address","error");return}if(e===oe.email){mt(t,"You can't share with yourself!","error");return}if(!e.includes("@")){mt(t,"Please enter a valid email address","error");return}try{console.log("Searching for user with email:",e);const r=jo(ge,"users"),s=Zo(r,ea("email","==",e));console.log("Executing query...");const o=await ra(s);if(console.log("Query results:",o.size,"documents found"),o.empty){mt(t,`No account found with email: ${e}<br><br>Ask them to create an account first, then try again.`,"error");return}const a=o.docs[0],l=a.id,u=a.data();if(console.log("Found user:",l,u),u.linkedTo===oe.uid){mt(t,`${e} is already linked to your account!`,"error");return}if(u.linkedTo){mt(t,`${e} is already linked to another account. They must unlink first.`,"error");return}console.log("Linking accounts..."),await ct(ke(ge,"users",l),{linkedTo:oe.uid}),console.log("Target user updated");const d=[...J.linkedWith||[]];d.includes(e)||d.push(e),await ct(ke(ge,"users",oe.uid),{linkedWith:d}),console.log("Own user updated"),mt(t,`✓ Successfully linked with ${e}!<br><br>They will now see your grocery lists when they log in.`,"success"),n.value="",K(`✓ Linked with ${e}!`),setTimeout(()=>Kh(),1e3)}catch(r){console.error("Error sharing - Full error:",r),console.error("Error code:",r.code),console.error("Error message:",r.message),mt(t,`Failed to send invite: ${r.message}<br><br>Check console for details.`,"error")}};function mt(n,e,t="success"){n.innerHTML=e,n.style.display="block",n.style.background=t==="error"?"#FEE2E2":"#D1FAE5",n.style.color=t==="error"?"#991B1B":"#065F46",n.style.padding="12px",n.style.borderRadius="8px"}function Wv(n,e,t){const r=document.createElement("div");r.className="grocery-item"+(n.checked?" checked":"");const s=document.createElement("input");s.type="checkbox",s.checked=n.checked||!1,s.addEventListener("change",()=>{n.checked=s.checked,r.classList.toggle("checked",s.checked),xe()});const o=document.createElement("span");o.textContent=n.name;const a=document.createElement("button");return a.textContent="×",a.addEventListener("click",()=>zv(n.name,e)),r.appendChild(s),r.appendChild(o),r.appendChild(a),r}window.removeBoughtItems=async function(n){const t=(V.lists[n]||[]).filter(r=>r.checked);if(t.length===0){K("No bought items to remove","error");return}t.forEach(r=>{V.stores.forEach(s=>{V.lists[s]=(V.lists[s]||[]).filter(o=>o.name.toLowerCase()!==r.name.toLowerCase())})}),await xe(),K(`✓ Removed ${t.length} bought item(s)`)};window.toggleStore=function(n){console.log("Toggle store:",n),Mt.has(n)?Mt.delete(n):Mt.add(n),localStorage.setItem("expandedStores",JSON.stringify([...Mt])),console.log("Expanded stores:",[...Mt]),Gh(),setTimeout(()=>{document.querySelectorAll(".quick-add-input").forEach(e=>{e.id.replace("quick-add-",""),aa(e.id,`${e.id}-autocomplete`)})},100)};window.clearList=async function(n){confirm(`Clear ALL items from ${n}?`)&&(V.lists[n]=[],await xe(),K(`✓ Cleared ${n}`))};let bt=null,cn=null;function zv(n,e){bt=n,cn=e;const t=document.getElementById("delete-modal"),r=document.getElementById("delete-item-name"),s=document.getElementById("delete-store-name");r.textContent=`"${n}"`,s.textContent=`📍 Only from ${e}`,t.classList.add("visible")}function Gs(){document.getElementById("delete-modal").classList.remove("visible"),bt=null,cn=null}document.getElementById("delete-all-btn").addEventListener("click",async()=>{bt&&(V.stores.forEach(n=>{V.lists[n]=(V.lists[n]||[]).filter(e=>e.name.toLowerCase()!==bt.toLowerCase())}),await xe(),K(`✓ Removed "${bt}" from all stores`),Gs())});document.getElementById("delete-one-btn").addEventListener("click",async()=>{!bt||!cn||(V.lists[cn]=(V.lists[cn]||[]).filter(n=>n.name.toLowerCase()!==bt.toLowerCase()),await xe(),K(`✓ Removed "${bt}" from ${cn}`),Gs())});document.getElementById("delete-cancel-btn").addEventListener("click",()=>{Gs()});document.getElementById("delete-modal").addEventListener("click",n=>{n.target.id==="delete-modal"&&Gs()});function Hv(){const n=document.getElementById("stores-tab");if(!n||!J)return;let e=`
    <div class="card">
