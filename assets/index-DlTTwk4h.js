 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const In=Xf;function Fl(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const r=Object.assign({name:Li,automaticDataCollectionEnabled:!1},e),s=r.name;if(typeof s!="string"||!s)throw wt.create("bad-app-name",{appName:String(s)});if(t||(t=Ll()),!t)throw wt.create("no-options");const o=ls.get(s);if(o){if(cs(t,o.options)&&cs(r,o.config))return o;throw wt.create("duplicate-app",{appName:s})}const a=new cf(s);for(const u of Oi.values())a.addComponent(u);const l=new np(t,r,a);return ls.set(s,l),l}function Ul(n=Li){const e=ls.get(n);if(!e&&n===Li&&Ll())return Fl();if(!e)throw wt.create("no-app",{appName:n});return e}function Tt(n,e,t){var r;let s=(r=Zf[n])!==null&&r!==void 0?r:n;t&&(s+=`-${t}`);const o=s.match(/\s|\//),a=e.match(/\s|\//);if(o||a){const l=[`Unable to register library "${s}" with version "${e}":`];o&&l.push(`library name "${s}" contains illegal characters (whitespace or "/")`),o&&a&&l.push("and"),a&&l.push(`version name "${e}" contains illegal characters (whitespace or "/")`),st.warn(l.join(" "));return}fn(new qt(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const us=new so("@firebase/auth");function mp(n,...e){us.logLevel<=q.WARN&&us.warn(`Auth (${In}): ${n}`,...e)}function Yr(n,...e){us.logLevel<=q.ERROR&&us.error(`Auth (${In}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gu(){return typeof qe().WorkerGlobalScope<"u"&&typeof qe().importScripts=="function"}async function Im(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function wm(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)===null||n===void 0?void 0:n.controller)||null}function Tm(){return gu()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
        ...
        <div class="card store-card">
          ...
          <div class="store-header" data-store="${s}" data-action="toggle-store">
            <div class="store-header-left">
              <div>
                ...
                <div class="store-subtitle">${a} item${a!==1?"s":""} remaining${o.filter(d=>d.checked).length>0?` • ${o.filter(d=>d.checked).length} checked`:""}</div>
              </div>
            </div>
          ...
          <div class="store-content ${u?"expanded":"collapsed"}" id="store-content-${l}">
            ...
            <div class="store-actions">
              ${o.filter(d=>d.checked).length>0?`<button class="store-action-btn btn-done" data-store="${s}" data-action="bought">✓ Remove Bought (${o.filter(d=>d.checked).length})</button>`:""}
